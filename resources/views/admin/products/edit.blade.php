    ...
    <form method="POST" action="/profile">
      ...
      ...
        ...
        <div class="form-group @error('quantity') has-error @enderror">
            ...
            <input type="number" class="form-control" name="quantity" id="quantity" min="1" max="10" step="1" value="{{$product->quantity}}">
            @error('quantity') 
                <span class="help-block">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <select name="recommended" id="recommended" class="form-control" value="{{$product->recommended}}">
